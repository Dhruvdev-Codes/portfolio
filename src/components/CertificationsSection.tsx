...
export function CertificationsSection() {
  return (
    <section id="credentials" className="py-16 md:py-24 border-t border-[#1e2738] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {PROFILE_DATA.certifications.map((cert, idx) => (
            <div
              key={idx}
              className="bg-[#151c2a] border border-[#222e44] rounded-xl p-5 flex flex-col justify-between hover:border-cyan-500/50 transition-all shadow-xl group"
            >
              <div>
                ...
                <p className="text-xs text-cyan-400/80 font-mono mb-4">{cert.issuer}</p>
              ...
              <div className="pt-3 border-t border-[#1e2738] flex items-center justify-between text-[11px] font-mono text-slate-500">
